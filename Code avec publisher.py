# -*- coding: utf-8 -*-
"""
Created on Sat Dec  7 15:07:10 2024
...
class FollowMe(Node):
    ...
    def scan_callback(self, msg):
      ...
      # Mesures à partir du début et de la fin
        ...
        self.get_logger().info(f"uuuuu Filtered point: {len(filtered_points)}")
        ...
        if not filtered_points:
            ...
            self.get_logger().info(f"yyyyy Y_TOTAl = {y_mean} COUNT = {count}")


            # Affichage des résultats
            self.get_logger().info(f"xxxxx Obstacle moyen: x = {x_mean}, y = {y_mean}")
